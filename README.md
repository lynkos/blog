...
- [**Ratings**](_includes/refactor-content.html#L52) (i.e. `{: rating="..."}` to stars) and [**Price**](_includes/refactor-content.html#L52) (i.e. `{: price="..."}` to dollars) shortcuts
- [**Thumbs Up/Down**](_includes/refactor-content.html#L43) (i.e. `{: thumbs="up/down"}` to icons) shortcuts
