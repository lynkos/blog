...
### Development
Start dev environment with [`run.sh`](tools/run.sh) shell script
...
> [!TIP]
> If [`run.sh`](tools/run.sh) doesn't work, use standard `jekyll` command
> ```sh
> bundle exec jekyll serve --incremental
> ```

Once your dev environment is up and running, _always_ rebuild the JavaScript bundle after updating file(s) in [`_javascript/`](_javascript) directory to apply those changes
...
## Additional Setup
Refer to [my blog](https://blog.lynkos.dev) for additional details and instructions on [my blogging setup and workflow](https://blog.lynkos.dev/posts/blogging-setup).
