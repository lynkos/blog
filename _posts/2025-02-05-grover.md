...
---
> This is a shorter article on Grover's algorithm, originally intended to be a Twitter (X) thread. For the full-length version, see [Quantum Search Algorithm (Full)](2025-03-13-grover-full.md).
{: .prompt-important }
